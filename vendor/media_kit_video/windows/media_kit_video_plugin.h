...
class MediaKitVideoPlugin : public flutter::Plugin {
 ...
 private:
  ...
  static constexpr UINT_PTR kNativeWindowSyncTimerId = 1002;
  static constexpr UINT kNativeWindowSyncIntervalMs = 16;
  ...
  void SetFlutterOverlayTransparency(bool enabled);
  void SetWindowAccentTransparency(bool enabled);
  ...
  bool flutter_overlay_transparent_ = false;
  bool native_window_sync_timer_running_ = false;
